...
export default function OrderForm(props) {
    ...
    const {setValues,values,errors,setErrors,handleInputChange} = props;
   ...
   return tempTotal + (item.quantity + (item.quantity * item.foodItemPrice))     
    },0);
    setValues({
        ...values,
